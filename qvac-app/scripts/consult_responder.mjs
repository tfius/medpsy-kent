...
const { device } = await serveConsult(code, async (question, context) => {
...
console.log(`[consult-responder] ${device.name} (${provider.name}) serving code "${code}" — waiting for consults. Ctrl-C to stop.`);
